...
<div class="w-screen h-screen fixed z-10 left-0 top-0 bg-white dark:bg-gray-900 flex flex-col justify-center items-center" out:fade={{ delay:1500,duration:800 }}>
  <div class="w-3/5 max-w-md max-h-[60%] bg-contain bg-logo dark:bg-logo-dark"><img class="opacity-0 w-full" alt="The Inner Essence : The Hidden Words of Bahá’u’lláh" src="/inneressence.png" /></div>
